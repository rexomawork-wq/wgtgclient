...
public class LauncherIconController {
    ...
    public enum LauncherIcon {
        ...
        JADE_WGTG("JadeWgtgIcon", R.drawable.wgtg_jade_background, R.drawable.wgtg_icon_foreground, R.string.WgtgIconJade),
        SUNSET_WGTG("SunsetWgtgIcon", R.drawable.wgtg_sunset_background, R.drawable.wgtg_icon_foreground, R.string.WgtgIconSunset),
        COBALT_WGTG("CobaltWgtgIcon", R.color.wgtg_cobalt, R.drawable.wgtg_icon_foreground, R.string.WgtgIconCobalt),
        PLUM_WGTG("PlumWgtgIcon", R.color.wgtg_plum, R.drawable.wgtg_icon_foreground, R.string.WgtgIconPlum),
        CORAL_WGTG("CoralWgtgIcon", R.color.wgtg_coral, R.drawable.wgtg_icon_foreground, R.string.WgtgIconCoral),
